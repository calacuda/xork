...
fn navigate_inventory(
    keys: Res<ButtonInput<KeyCode>>,
    mut nav_ev: MessageWriter<InvNavDir>,
    ...
    if keys.just_released(KeyCode::ArrowUp) {
        ...
        // nav_ev.write(InvNavDir::NextScreen);
        inv_index.0 = 0;
        inv_index.1 = 0;
